...
const EditJobPage = () => {
    ...
    const [experienceLevelType, setExperienceLevelType] = useState("Entry");
    ...
    useEffect(() => {
        const fetchJob = async () => {
            try {
                ...
                setExperienceLevelType(data.experienceLevelType);
        ...
        <div className="create">
            ...
            {loading ? (
                ...
                <form onSubmit={submitForm}>
                    ...
                    <select
                        value={experienceLevelType}
                        onChange={(e) => setExperienceLevelType(e.target.value)}
                    >
